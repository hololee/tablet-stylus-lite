...
public class padRightActivity extends Activity implements CaulyCloseAdListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pad_right);
        //CloseAd 초기화
        ...
        view = (RelativeLayout) findViewById(R.id.pad);
        ...
        button4 = (ImageButton) findViewById(R.id.bt_04);
                ...
                switch (event.getAction()) {
                    ...
                    case MotionEvent.ACTION_DOWN: {
                        ...
                        if (modeChanged) {
                            ...
                            try {
                                new modeThread(MODE_SET, String.valueOf((int) ((phoneY - event.getY())) - dpToPx(getApplicationContext(), 80)), String.valueOf((int) (event.getX()))).start();
                                Thread.sleep(1);
                    ...
                    case MotionEvent.ACTION_MOVE: {
                        ...
                        try {
                            ...
                            if (modeSet) {
                                ...
                                new sendThread(String.valueOf((int) (finalY * (-1))), String.valueOf((int) finalX)).start();
                                Thread.sleep(1);
                            }
        ...
        newButton3.setImageResource(R.drawable.button_v_right_pressed);
        ...
        newButton3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!newButon3Selected) {
                    ...
                    newButton3.setImageResource(R.drawable.button_v_right);
                    newButton3.setScaleType(ImageView.ScaleType.CENTER_INSIDE);
        ...
        button5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!modeSet) {
                    button5.setImageResource(R.drawable.button_mode_right_pressed);
                    ...
                    button5.setImageResource(R.drawable.button_mode_right);
                    button5.setScaleType(ImageView.ScaleType.CENTER_INSIDE);
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                switch (event.getAction()) {
                    ...
                    case MotionEvent.ACTION_DOWN: {
                        ...
                        button3.setImageResource(R.drawable.button_3_right_pressed);
...
*/
                    ...
                    case MotionEvent.ACTION_UP: {
                        ...
                        button3.setImageResource(R.drawable.button_3_right);
                        button3.setScaleType(ImageView.ScaleType.CENTER_INSIDE);
...
*/
        ...
        button4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!buttonSFlag) {
                    ...
                    button4.setImageResource(R.drawable.button_s_right_pressed);
                    ...
                    button4.setImageResource(R.drawable.button_s_right);
                    button4.setScaleType(ImageView.ScaleType.CENTER_INSIDE);
    ...
    public class padView extends SurfaceView implements SurfaceHolder.Callback {
        ...
        private padViewThreadRight mThread = new padViewThreadRight(getHolder(), this);
